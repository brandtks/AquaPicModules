...
${OBJECTDIR}/_ext/b0c5a78b/common.o: ../../common/common.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/b0c5a78b/common.o ../../common/common.c

${OBJECTDIR}/_ext/7d1870e3/pins.o: ../../pins/test/pins.c
	${MKDIR} -p ${OBJECTDIR}/_ext/7d1870e3
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/7d1870e3/pins.o ../../pins/test/pins.c

${OBJECTDIR}/_ext/f8b2fa93/uart.o: ../../uart/test/uart.c
	${MKDIR} -p ${OBJECTDIR}/_ext/f8b2fa93
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/f8b2fa93/uart.o ../../uart/test/uart.c

${OBJECTDIR}/_ext/5c0/aquaPicBus.o: ../aquaPicBus.c
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/aquaPicBus.o ../aquaPicBus.c

${OBJECTDIR}/testAquaPicBus.o: testAquaPicBus.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/testAquaPicBus.o testAquaPicBus.c
