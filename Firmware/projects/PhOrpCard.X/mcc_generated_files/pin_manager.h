...
*/
#define N_Y_LED_SetHigh()          ( LATBSET = (1 << 0) )
/**
  @Summary
...
*/
#define N_Y_LED_SetLow()           ( LATBCLR = (1 << 0) )
/**
  @Summary
...
*/
#define N_Y_LED_Toggle()           ( LATBINV = (1 << 0) )
/**
  @Summary
...
*/
#define N_Y_LED_GetValue()         PORTBbits.RB0
/**
  @Summary
...
*/
#define N_Y_LED_SetDigitalInput()   ( TRISBSET = (1 << 0) )
/**
  @Summary
...
*/
#define N_Y_LED_SetDigitalOutput()   ( TRISBCLR = (1 << 0) )
/**
  @Summary
...
*/
#define N_G_LED_SetHigh()          ( LATBSET = (1 << 1) )
/**
  @Summary
...
*/
#define N_G_LED_SetLow()           ( LATBCLR = (1 << 1) )
/**
  @Summary
...
*/
#define N_G_LED_Toggle()           ( LATBINV = (1 << 1) )
/**
  @Summary
...
*/
#define N_G_LED_GetValue()         PORTBbits.RB1
/**
  @Summary
...
*/
#define N_G_LED_SetDigitalInput()   ( TRISBSET = (1 << 1) )
/**
  @Summary
...
*/
#define N_G_LED_SetDigitalOutput()   ( TRISBCLR = (1 << 1) )
/**
  @Summary
...
*/
#define N_R_LED_SetHigh()          ( LATBSET = (1 << 2) )
/**
  @Summary
...
*/
#define N_R_LED_SetLow()           ( LATBCLR = (1 << 2) )
/**
  @Summary
...
*/
#define N_R_LED_Toggle()           ( LATBINV = (1 << 2) )
/**
  @Summary
...
*/
#define N_R_LED_GetValue()         PORTBbits.RB2
/**
  @Summary
...
*/
#define N_R_LED_SetDigitalInput()   ( TRISBSET = (1 << 2) )
/**
  @Summary
...
*/
#define N_R_LED_SetDigitalOutput()   ( TRISBCLR = (1 << 2) )
/**
  @Summary
...
*/
#define EN_PH_SetHigh()          ( LATBSET = (1 << 3) )
/**
  @Summary
...
*/
#define EN_PH_SetLow()           ( LATBCLR = (1 << 3) )
/**
  @Summary
...
*/
#define EN_PH_Toggle()           ( LATBINV = (1 << 3) )
/**
  @Summary
  ...
  @Example
    ...
    // Read RB3
    postValue = EN_PH_GetValue();
    </code>

*/
#define EN_PH_GetValue()         PORTBbits.RB3
/**
  @Summary
  ...
  @Example
    ...
    EN_PH_SetDigitalInput();
    </code>

*/
#define EN_PH_SetDigitalInput()   ( TRISBSET = (1 << 3) )
/**
  @Summary
  ...
  @Example
    ...
    EN_PH_SetDigitalOutput();
    </code>

*/
#define EN_PH_SetDigitalOutput()   ( TRISBCLR = (1 << 3) )
/**
  @Summary
...
*/
#define EN_ORP_SetHigh()          ( LATBSET = (1 << 4) )
/**
  @Summary
...
*/
#define EN_ORP_SetLow()           ( LATBCLR = (1 << 4) )
/**
  @Summary
...
*/
#define EN_ORP_Toggle()           ( LATBINV = (1 << 4) )
/**
  @Summary
  ...
  @Example
    ...
    // Read RB4
    postValue = EN_ORP_GetValue();
    </code>

*/
#define EN_ORP_GetValue()         PORTBbits.RB4
/**
  @Summary
  ...
  @Example
    ...
    EN_ORP_SetDigitalInput();
    </code>

*/
#define EN_ORP_SetDigitalInput()   ( TRISBSET = (1 << 4) )
/**
  @Summary
  ...
  @Example
    ...
    EN_ORP_SetDigitalOutput();
    </code>

*/
#define EN_ORP_SetDigitalOutput()   ( TRISBCLR = (1 << 4) )
