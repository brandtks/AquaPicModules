...
*/
#define N_R_LED_SetHigh()          ( LATBSET = (1 << 0) )
/**
  @Summary
...
*/
#define N_R_LED_SetLow()           ( LATBCLR = (1 << 0) )
/**
  @Summary
...
*/
#define N_R_LED_Toggle()           ( LATBINV = (1 << 0) )
/**
  @Summary
...
*/
#define N_R_LED_GetValue()         PORTBbits.RB0
/**
  @Summary
...
*/
#define N_R_LED_SetDigitalInput()   ( TRISBSET = (1 << 0) )
/**
  @Summary
...
*/
#define N_R_LED_SetDigitalOutput()   ( TRISBCLR = (1 << 0) )
/**
  @Summary
...
*/
#define N_Y_LED_SetHigh()          ( LATBSET = (1 << 2) )
/**
  @Summary
...
*/
#define N_Y_LED_SetLow()           ( LATBCLR = (1 << 2) )
/**
  @Summary
...
*/
#define N_Y_LED_Toggle()           ( LATBINV = (1 << 2) )
/**
  @Summary
...
*/
#define N_Y_LED_GetValue()         PORTBbits.RB2
/**
  @Summary
...
*/
#define N_Y_LED_SetDigitalInput()   ( TRISBSET = (1 << 2) )
/**
  @Summary
...
*/
#define N_Y_LED_SetDigitalOutput()   ( TRISBCLR = (1 << 2) )
